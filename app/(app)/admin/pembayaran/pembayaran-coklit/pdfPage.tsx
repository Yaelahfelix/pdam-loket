            ...
            <tr>
              <td>
                        ...
                        <tr key={index}>
                          ...
                          {data.tagihan.map((item) => (
                            <>
                              ...
                              >
                                {formatRupiah(Number(item.materai))}
                              </td>
                              <td
                                style={{
                                  border: "1px solid #000",
                ...
                <div className="text-[8px]">
                  <p>Note:</p>
                  <p>
                    Total Tagihan akan berubah jika melakukan pembayaran diatas
                    tgl 20 setiap bulannya
                  </p>
                </div>
                {/* ttd */}
...
const CetakPDF: React.FC<DRDTableProps> = (props) => {
